...
variable "af3ipynb_bucket" {
  description = "Toolkit deployment variable: af3ipynb_bucket"
  type        = string
}
...
variable "subnetwork_af3_network" {
  description = "Automatically generated input from previous groups (gcluster import-inputs --help)"
  type        = any
}
